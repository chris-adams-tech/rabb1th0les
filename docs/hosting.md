...
> [!hint]
> Some Quartz features (like [[RSS Feed]] and sitemap generation) require `baseUrl` to be configured properly in your [[rabb1th0les/quartz/docs/configuration]] to work properly. Make sure you set this before deploying!
