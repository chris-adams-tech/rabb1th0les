...
Then, you can use it like any other component in `quartz.layout.ts` via `Component.YourComponent()`. See the [[rabb1th0les/quartz/docs/configuration#Layout|layout]] section for more details.
